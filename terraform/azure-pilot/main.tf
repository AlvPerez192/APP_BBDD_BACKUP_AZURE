# =============================================================================
# PILOT LIGHT en Azure - Sweden Central (cuota verificada)
# =============================================================================
# Esta infraestructura SOLO se despliega cuando AWS cae (failover).
# En operación normal NO existe y no genera coste.
#
# Región: Sweden Central (swedencentral)
#   Seleccionada porque es la única región permitida por la política de
#   Azure for Students donde hay SKUs disponibles Y cuota asignada.
#
# SKUs verificados con az vm list-skus y az vm list-usage:
#   - VM: Standard_B1ms (1 vCPU, 2 GB RAM) — cuota 4 vCPUs
#   - Azure DB: B_Standard_B1ms
#
# Flujo de tráfico:
#   Usuario → HTTPS (443) → VM (Nginx) → HTTP (localhost:80) → Docker → Azure DB
#
# Backend de Terraform:
#   - Almacenado en Azure Storage (stgalvarospain2026, contenedor tfstate)
#   - La Storage Account está en Spain Central pero el backend funciona
...
locals {
  # Región centralizada: cambiar aquí afecta a todos los recursos
  location = "swedencentral"
}

# =============================================================================
# RESOURCE GROUP
# El resource group está en Spain Central pero puede contener recursos
# en cualquier región. Cada recurso especifica su location individual.
# =============================================================================
...
# =============================================================================
# RED: VNet y subredes (en Sweden Central)
# =============================================================================
...
# =============================================================================
# VM CON DOCKER (Standard_B1ms - 1 vCPU, 2 GB RAM)
# =============================================================================
...
# =============================================================================
# AZURE DB FOR MYSQL FLEXIBLE SERVER (en Sweden Central)
# =============================================================================
