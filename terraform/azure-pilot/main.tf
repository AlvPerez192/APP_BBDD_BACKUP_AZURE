...
# Recursos creados:
#   - VNet + 2 subredes
#   - NSG de la VM (SSH + HTTPS desde internet)
#   - VM (Standard_B1ms) con IP pública
#   - Azure DB for MySQL Flexible Server (B_Standard_B1ms)
#   - Private DNS Zone para Azure DB
#
# Backend de Terraform:
#   - Almacenado en Azure Storage (contenedor tfstate de la storage account
#     stgalvarospain2026) para que el failover funcione sin depender de AWS.
# =============================================================================
